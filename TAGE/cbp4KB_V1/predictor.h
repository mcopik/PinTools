#ifndef _PREDICTOR_4KBV1_H_
#define _PREDICTOR_4KBV1_H_
...
int m[NHIST + 1]= {0,4,9,13,24,37}; // history lengths
int TB[NHIST+1]= {0,7,7,7,8,9};		// tag width for the different tagged tables
